    ...
    <header className='py-10 w-full'>
      <div className='flex flex-col lg:flex-row items-center text-primary justify-between gap-5'>
        ...
        <div className='flex flex-col md:flex-row gap-4 items-center '>
          <div>
            <button className='hover:-translate-y-0.5 primary-btn text-[#100702] px-3 py-1 rounded-md flex items-center gap-2  transition-all delay-300 flex-1'>
              <FaWallet className='text-[#100702]' />
              Connect Wallet
            </button>
          </div>
          <div>
            <button className='hover:-translate-y-0.5 bg-white text-black px-5 py-1 rounded-md flex items-center gap-2 transition-all delay-300 flex-1'>
              <FaCoins />
              ETH Chain
            </button>
          </div>
